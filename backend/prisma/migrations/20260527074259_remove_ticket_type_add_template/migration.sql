...
INSERT INTO "new_tickets" ("assignee_id", "author_id", "body", "closed_at", "created_at", "id", "priority", "server_id", "status", "title", "updated_at") SELECT "assignee_id", "author_id", "body", "closed_at", "created_at", "id", "priority", "server_id", "status", "title", "updated_at" FROM "tickets";
DROP TABLE "tickets";
