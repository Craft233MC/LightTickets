...
const selectedLabel = () => props.options.find(o => o.value === model.value)?.label ?? props.placeholder ?? '请选择'
</script>

<template>
  <div class="space-y-1.5" ref="wrapperEl">
    ...
    <div class="relative">
      ...
      >
        <span :class="model ? '' : 'text-slate-400 dark:text-slate-500'">{{ selectedLabel() }}</span>
        <Icon
